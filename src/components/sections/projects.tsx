      ...
      <div className="sticky top-0 h-[100dvh] flex items-center overflow-hidden pt-16 pb-4 sm:pt-20 sm:pb-8">
        ...
        >
          ...
          {projects.map((project, index) => (
            <div
              key={project.title}
              className="w-[84vw] sm:w-[65vw] max-w-[640px] shrink-0 relative group"
            >
              <div className="p-3.5 sm:p-7 rounded-2xl border-[2.5px] sm:border-[3px] border-[#2b1a05] bg-[#faf7f3] shadow-[5px_5px_0_#2b1a05] sm:shadow-[8px_8px_0_#2b1a05] transition-all duration-300 group-hover:shadow-[10px_10px_0_#2b1a05] group-hover:-translate-y-1 flex flex-col gap-2.5 sm:gap-4 max-h-[calc(100dvh-100px)] overflow-hidden">
                ...
                <div 
                  className="w-full aspect-[16/9] sm:aspect-[16/10] max-h-[22vh] sm:max-h-[36vh] rounded-xl overflow-hidden relative flex items-center justify-center p-2.5 sm:p-6 border-[2px] sm:border-[2.5px] border-[#2b1a05] shadow-inner bg-gradient-to-br from-[#ffe3b0] via-[#faf7f3] to-[#efe9da]"
                >
                  <img
                    src={project.image}
                    alt={project.title}
